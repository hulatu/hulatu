...
`profile.hulatu.com`、`run.hulatu.com` 等其他子站不适用本页，请以子站各自的页面说明为准；如没有单独说明，也可通过文末邮箱联系我。
...
- 不登录 GitHub 也可以浏览评论；**发表评论或点赞需要 GitHub 账号**，这一过程由 GitHub 处理你的账号信息。
- giscus 可能在浏览器本地存储（LocalStorage）中保存主题等偏好。
...
如对本隐私政策有疑问，可通过邮箱联系：`flyhulatu@gmail.com`。
